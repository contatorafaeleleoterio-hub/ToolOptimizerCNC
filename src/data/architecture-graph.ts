...
const FILE_LINES: Record<string, number> = {
  ...
  'src/components/mobile/mobile-config-section.tsx': 433,
  'src/components/mobile/mobile-cutting-params.tsx': 353,
  'src/components/mobile/mobile-fine-tune-section.tsx': 14,
  'src/components/mobile/mobile-header.tsx': 20,
  'src/components/mobile/mobile-adjust-section.tsx': 34,
  'src/components/mobile/mobile-mini-result-bar.tsx': 94,
  'src/components/mobile/mobile-simulate-button.tsx': 69,
  'src/components/mobile/mobile-tab-bar.tsx': 80,
  'src/components/mobile/hmi-visor.tsx': 146,
  'src/components/mobile/mobile-results-section.tsx': 441,
  'src/components/mobile/mobile-indicators-block.tsx': 77,
  'src/components/modals/favorite-edit-modal.tsx': 197,
  'src/components/modals/tool-edit-modal.tsx': 180,
  'src/components/param-explanation.tsx': 46,
  'src/components/parameter-health-bar.tsx': 120,
  ...
  'src/components/viewport-guard.tsx': 20,
  ...
  'src/pages/mobile-page.tsx': 96,
  'src/pages/settings-page.tsx': 1093,
  'src/pages/architecture-page.tsx': 57,
  'src/pages/favorites-page.tsx': 466,
  'src/pages/privacy-policy-page.tsx': 130,
  'src/shared/storage-service.ts': 71,
  'src/store/favorites-store.ts': 109,
  'src/store/history-store.ts': 121,
  'src/store/index.ts': 2,
  'src/store/machining-store.ts': 469,
  'src/types/index.ts': 232,
  'src/utils/haptics.ts': 72,
...
const NODE_SEEDS: NodeSeed[] = [
  ...
  { id: 'favorites-page', labelPt: 'Pagina de favoritos de simulacao', category: 'page', filePath: 'src/pages/favorites-page.tsx', group: 'pages' },
  { id: 'privacy-policy-page', labelPt: 'Pagina de politica de privacidade', category: 'page', filePath: 'src/pages/privacy-policy-page.tsx', group: 'pages' },
  ...
  { id: 'mobile-cutting-params', labelPt: 'Sliders de parametros de corte (Vc/fz/ap/ae), compartilhado entre Configurar e Ajustar', category: 'component', filePath: 'src/components/mobile/mobile-cutting-params.tsx', group: 'components' },
  ...
  { id: 'mobile-adjust-section', labelPt: 'Secao mobile de ajustes pos-simulacao', category: 'component', filePath: 'src/components/mobile/mobile-adjust-section.tsx', group: 'components' },
  { id: 'mobile-mini-result-bar', labelPt: 'Indicador linear compacto mobile', category: 'component', filePath: 'src/components/mobile/mobile-mini-result-bar.tsx', group: 'components' },
  { id: 'mobile-simulate-button', labelPt: 'Botao mobile de simulacao com progresso', category: 'component', filePath: 'src/components/mobile/mobile-simulate-button.tsx', group: 'components' },
  { id: 'mobile-tab-bar', labelPt: 'Navegacao inferior mobile por abas', category: 'component', filePath: 'src/components/mobile/mobile-tab-bar.tsx', group: 'components' },
  { id: 'hmi-visor', labelPt: 'Visor HMI mobile de resultados', category: 'component', filePath: 'src/components/mobile/hmi-visor.tsx', group: 'components' },
  { id: 'mobile-indicators-block', labelPt: 'Bloco de indicadores tempo real (Avanco/MRR/Saude), compartilhado entre Ajustar/HMI/Educacional', category: 'component', filePath: 'src/components/mobile/mobile-indicators-block.tsx', group: 'components' },
  ...
  { id: 'favorite-edit-modal', labelPt: 'Modal de edicao de favorito', category: 'component', filePath: 'src/components/modals/favorite-edit-modal.tsx', group: 'components' },
  { id: 'tool-edit-modal', labelPt: 'Modal de edicao de ferramenta salva', category: 'component', filePath: 'src/components/modals/tool-edit-modal.tsx', group: 'components' },
  { id: 'param-explanation', labelPt: 'Popover educacional de parametro', category: 'component', filePath: 'src/components/param-explanation.tsx', group: 'components' },
  { id: 'parameter-health-bar', labelPt: 'Funcoes puras de zona de saude dos parametros', category: 'util', filePath: 'src/components/parameter-health-bar.tsx', group: 'components' },
  ...
  { id: 'viewport-guard', labelPt: 'Guard responsivo entre desktop e mobile', category: 'component', filePath: 'src/components/viewport-guard.tsx', group: 'components' },
  ...
  { id: 'favorites-store', labelPt: 'Store dos favoritos de simulacao', category: 'store', filePath: 'src/store/favorites-store.ts', group: 'stores' },
  ...
  { id: 'storage-service', labelPt: 'Persistencia hibrida web e Capacitor', category: 'store', filePath: 'src/shared/storage-service.ts', group: 'stores' },
  ...
  { id: 'haptics', labelPt: 'Wrapper de feedback tatico Capacitor', category: 'util', filePath: 'src/utils/haptics.ts', group: 'hooks' },
...
const LEVEL2_EDGES: ArchEdge[] = [
  ...
  { from: 'main', to: 'favorites-page', type: 'renders', level: 2 },
  { from: 'main', to: 'privacy-policy-page', type: 'renders', level: 2 },
  ...
  { from: 'bug-report-button', to: 'modal', type: 'renders', level: 2 },
  { from: 'modal', to: 'design-tokens', type: 'import', level: 2 },
  { from: 'favorite-edit-modal', to: 'modal', type: 'renders', level: 2 },
  { from: 'tool-edit-modal', to: 'modal', type: 'renders', level: 2 },
  ...
  { from: 'config-panel', to: 'fine-tune-panel', type: 'renders', level: 2 },
  { from: 'config-panel', to: 'tool-edit-modal', type: 'renders', level: 2 },
  ...
  { from: 'fine-tune-panel', to: 'param-explanation', type: 'renders', level: 2 },
  ...
  { from: 'formula-card', to: 'collapsible-section', type: 'renders', level: 2 },
  ...
  { from: 'results-panel', to: 'favorite-edit-modal', type: 'renders', level: 2 },
  { from: 'results-panel', to: 'favorites-store', type: 'state', level: 2 },
  ...
  { from: 'segmented-gradient-bar', to: 'parameter-health-bar', type: 'import', level: 2 },
  { from: 'viewport-redirect', to: 'use-is-mobile', type: 'import', level: 2 },
  { from: 'viewport-redirect', to: 'viewport-guard', type: 'import', level: 2 },
  ...
  { from: 'mobile-page', to: 'mobile-adjust-section', type: 'renders', level: 2 },
  { from: 'mobile-page', to: 'mobile-simulate-button', type: 'renders', level: 2 },
  { from: 'mobile-page', to: 'mobile-tab-bar', type: 'renders', level: 2 },
  ...
  { from: 'mobile-tab-bar', to: 'haptics', type: 'import', level: 2 },
  { from: 'mobile-config-section', to: 'ui-helpers', type: 'renders', level: 2 },
  { from: 'mobile-config-section', to: 'mobile-cutting-params', type: 'renders', level: 2 },
  { from: 'mobile-config-section', to: 'tool-edit-modal', type: 'renders', level: 2 },
  { from: 'mobile-config-section', to: 'haptics', type: 'import', level: 2 },
  ...
  { from: 'mobile-results-section', to: 'hmi-visor', type: 'renders', level: 2 },
  ...
  { from: 'mobile-results-section', to: 'mobile-indicators-block', type: 'renders', level: 2 },
  { from: 'mobile-results-section', to: 'tool-edit-modal', type: 'renders', level: 2 },
  { from: 'mobile-results-section', to: 'haptics', type: 'import', level: 2 },
  { from: 'mobile-results-section', to: 'store-index', type: 'state', level: 2 },
  { from: 'hmi-visor', to: 'haptics', type: 'import', level: 2 },
  { from: 'hmi-visor', to: 'mobile-indicators-block', type: 'renders', level: 2 },
  { from: 'mobile-indicators-block', to: 'store-index', type: 'state', level: 2 },
  { from: 'mobile-indicators-block', to: 'mobile-mini-result-bar', type: 'renders', level: 2 },
  { from: 'mobile-indicators-block', to: 'types-index', type: 'import', level: 2 },
  { from: 'mobile-adjust-section', to: 'mobile-cutting-params', type: 'renders', level: 2 },
  { from: 'mobile-adjust-section', to: 'mobile-indicators-block', type: 'renders', level: 2 },
  { from: 'mobile-fine-tune-section', to: 'mobile-cutting-params', type: 'renders', level: 2 },
  { from: 'mobile-fine-tune-section', to: 'ui-helpers', type: 'renders', level: 2 },
  { from: 'mobile-cutting-params', to: 'segmented-gradient-bar', type: 'renders', level: 2 },
  { from: 'mobile-cutting-params', to: 'param-explanation', type: 'renders', level: 2 },
  { from: 'mobile-cutting-params', to: 'favorites-store', type: 'state', level: 2 },
  { from: 'mobile-cutting-params', to: 'data-index', type: 'import', level: 2 },
  { from: 'mobile-cutting-params', to: 'engine-index', type: 'import', level: 2 },
  { from: 'mobile-cutting-params', to: 'store-index', type: 'state', level: 2 },
  { from: 'mobile-cutting-params', to: 'types-index', type: 'import', level: 2 },
  ...
  { from: 'favorites-page', to: 'favorite-edit-modal', type: 'renders', level: 2 },
  { from: 'favorites-page', to: 'favorites-store', type: 'state', level: 2 },
  { from: 'favorites-page', to: 'types-index', type: 'import', level: 2 },
  ...
  { from: 'store-index', to: 'favorites-store', type: 'import', level: 2 },
  { from: 'history-store', to: 'types-index', type: 'import', level: 2 },
  { from: 'history-store', to: 'storage-service', type: 'import', level: 2 },
  ...
  { from: 'machining-store', to: 'storage-service', type: 'import', level: 2 },
  { from: 'favorites-store', to: 'types-index', type: 'import', level: 2 },
  { from: 'favorites-store', to: 'storage-service', type: 'import', level: 2 },
