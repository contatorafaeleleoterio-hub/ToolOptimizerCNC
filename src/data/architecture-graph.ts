...
const FILE_LINES: Record<string, number> = {
  'src/App.tsx': 45,
  'src/main.tsx': 33,
  'src/components/bidirectional-slider.tsx': 201,
  ...
  'src/components/mobile/mobile-fine-tune-section.tsx': 286,
  'src/components/mobile/mobile-header.tsx': 20,
  'src/components/mobile/mobile-results-section.tsx': 64,
  'src/components/parameter-health-bar.tsx': 311,
  'src/components/results-panel.tsx': 218,
  ...
  'src/components/architecture/architecture-map.tsx': 331,
  'src/data/index.ts': 3,
  ...
  'src/engine/recommendations.ts': 268,
