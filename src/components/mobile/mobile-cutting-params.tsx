...
/**
 * Shared list of 4 cutting-parameter rows (Vc/fz/ae/ap) — indicator + touch slider +
 * ± buttons + free value input + educational explanation. Used identically by the
 * Configurar tab (initial setup) and the Ajustar tab (post-simulation fine-tune) —
 * the ideal-range indicator comes from saved favorites, not from `resultado`, so
 * behavior is the same before or after simulating.
 */
export function MobileCuttingParamsSliders() {
