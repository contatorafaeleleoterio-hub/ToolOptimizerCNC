  ...
  cenarios: {
        ...
        oQueMexer: [
          {
            ...
            instrucao: 'Reduza o balanço (L) para 40 mm (hoje 45).',
            explicacao: 'A relação balanço/diâmetro (L/D) cai de 4,5 para 4,0 e a deflexão cai cerca de 30% — a ferramenta volta ao limiar da haste comum.',
            contrapartida: 'Em troca: a ferramenta alcança menos em cavidades profundas.'
          },
          {
    ...
    cenario3: {
      ...
      calculado: {
        ...
        oQueVaiAcontecer: [
          'Condição fisicamente impossível: o sistema calculou com base no valor informado, mas a ferramenta física não possui diâmetro suficiente para engajar 12 mm de penetração radial.',
        ...
        oQueMexer: [
          {
            ...
            instrucao: 'Reduza a penetração radial (ae) para no máximo 10,0 mm (largura plena) ou use passe lateral de 2,5 a 5,0 mm.',
