...
**MODO:** MVP Launch — Web (tooloptimizercnc.com.br) → Play Store/iOS futuramente
**OBJETIVO:** Publicar ToolOptimizer CNC na Web o mais rápido possível para validar demanda de mercado de operadores CNC.
**PRINCÍPIO:** Cortar features não-essenciais. Toda nova feature vai para o backlog pós-lançamento. Velocidade > perfeição.
**MONETIZAÇÃO:** Gratuito (MVP)
**CONTA DEV:** Não existe (Web não requer — Cloudflare Workers já ativo em tooloptimizercnc.com.br)
