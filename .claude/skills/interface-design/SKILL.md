...
description: Design engineering for ToolOptimizer CNC. Build interfaces with craft, memory, and consistency. Maintains design decisions across sessions via .interface-design/system.md.
