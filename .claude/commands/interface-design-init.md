...
description: Build UI with craft and consistency. Applies ToolOptimizer CNC design system.
...
2. `.interface-design/system.md` — ToolOptimizer CNC design tokens, patterns, and rules

Do not skip this. The craft knowledge and project-specific decisions are in these files.
